          ...
          <Card className="max-w-md">
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <Button onClick={fetchAnnouncements} className="gap-2 bg-blue-600 hover:bg-blue-700">
  ...
  return (
    <DashboardLayout role="student">
      <div className="space-y-6 pb-8">
        {/* Header */}
        <div className="bg-linear-to-r from-blue-600 to-indigo-600 rounded-xl p-6 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-linear-to-br from-indigo-50 to-indigo-100 border-indigo-200">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-indigo-900">{stats.students}</div>
            </CardContent>
          </Card>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Select value={filterAudience} onValueChange={setFilterAudience}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="students">For Students</SelectItem>
              ...
              <div className="space-y-4">
                {filteredAnnouncements.map((announcement, index) => (
                  <div
                    ...
                    className="border border-gray-200 rounded-lg p-5 hover:shadow-md transition-all hover:border-blue-300 cursor-pointer"
